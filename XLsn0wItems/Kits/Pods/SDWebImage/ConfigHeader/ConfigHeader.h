...
#define kWeChatAppKey     @"wx7c7259d676763944"
#define kWeChatAppSecret  @"1e35b7855286a7896cc00fe70cbb8991"
...
#define JPushAppKey     @"a2a5f2816bf3980155af29aa"
...
///App全局使用色
#define AppThemeColor               [UIColor xlsn0w_hexString:@"#C30E22"]
#define AppSecondLevelColor         [UIColor xlsn0w_hexString:@"#C30E22"]
#define AppViewBackgroundColor      [UIColor xlsn0w_hexString:@"#F0F0F0"]
...
#ifdef DEBUG
#define HLLog(FORMAT, ...) fprintf(stderr, "类名(%s): 第 %d 行: \t%s\n\n", [[[NSString stringWithUTF8String: __FILE__] lastPathComponent] UTF8String], __LINE__, [[NSString stringWithFormat: FORMAT, ## __VA_ARGS__] UTF8String]);
#else
...
#define REMEMBER_BUTTON @"REMEMBER_BUTTON_hoolink" //记住账号按钮 key
#define UserName_hoolink @"UserName_hoolink" //用户名 key
#define UserPassword_hoolink @"UserPassword_hoolink" //密码 key
#define HL_User_Login_Token @"HL_User_Login_Token"
#define HL_User_Login_UserId @"HL_User_Login_UserId"
...
///信息提示框
#define show(text) [AlertShow showAlertText:text];
...
#define NotificationShared [NSNotificationCenter defaultCenter]
...
#define kAppWindow          [UIApplication sharedApplication].delegate.window
#define kAppDelegate        [AppDelegate shared]
